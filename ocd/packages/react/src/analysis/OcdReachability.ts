...
**
** Only fields confirmed in generated model interfaces are referenced.
...
function buildMaps(design: OcdDesign): DesignMaps {
...
type ReachabilityRule = (design: OcdDesign, maps: DesignMaps) => GovernanceFinding[]
...
const REACHABILITY_RULES: ReadonlyArray<ReachabilityRule> = [
